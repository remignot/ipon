# ------------------------------------------------------------------------------
"""
  Configuration file of the iptyhon profile "basilic_ipy". 
...
c.TerminalInteractiveShell.highlighting_style_overrides = {
  ...
  # For prompt
  Token.Prompt:               "#4242FF bold", #"#FF6600 nobold",             
  Token.PromptNum:            "#4242FF bold", #"#FF6600 nobold",             
  Token.OutPrompt:            "#4242FF bold", #"#FFFFFF nobold",
  Token.OutPromptNum:         "#4242FF bold", #"#FFFFFF nobold",
  ...
  Token.Punctuation:          "#AAAAAA nobold",      # , ; : () [] {}
  ...
  Number:                     "#AF65FF nobold",      # Numbers        
  Token.Number:               "#AF65FF nobold",
  Token.Operator:             "#F38472 nobold", #"#FFB700 nobold",               
    # + * - % // ** = += *= == < >= & ~ etc.
  Operator.Word:              "#F38472 nobold", #"#FFB700 nobold",
    # and, in, not, or, is. 
